...
test('N.findLastIndex', (t) => {
  ...
  t.equals(findLastIndex(val => val > 2, [0, 1, 2, 3, 2]), 3, 'returns index of last matching element');
  t.equals(findLastIndex(val => val > 2, [0, 1, 0, 1]), -1, 'returns -1 there is no matching elements');
